        ...
        <section className="relative bg-gradient-to-r from-[#0066CC] via-[#0052A3] to-[#003D7A] py-20 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-8 animate-fade-in-up">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight" data-testid="jobs-page-title">
                Find Your Perfect Job
              </h1>
              <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed" data-testid="jobs-page-subtitle">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <Card className="p-8 mb-12 shadow-2xl border-0 bg-white/95 backdrop-blur-sm animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                >
                  <SelectTrigger className="h-14 text-lg border-2 border-gray-200 focus:border-[#0066CC] focus:ring-[#0066CC]/20 transition-all duration-300 rounded-xl" data-testid="job-category-select">
              ...
              {showAdvancedFilters && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 border-t border-gray-200 animate-fade-in-up">
                  ...
                  >
                    <SelectTrigger className="h-12 border-2 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 transition-all duration-300 rounded-xl" data-testid="job-type-select">
                  ...
                  >
                    <SelectTrigger className="h-12 border-2 border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 transition-all duration-300 rounded-xl" data-testid="job-experience-select">
                  ...
                  <div className="flex space-x-3">
                    <Button 
                      ...
                      variant="outline"
                      className="flex-1 h-12 border-2 border-gray-200 hover:border-red-500 hover:bg-red-50 hover:text-red-600 transition-all duration-300 rounded-xl"
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              <div className="text-lg font-semibold text-gray-700" data-testid="jobs-count">
                {isLoading ? (
            ...
            {/* Job Listings */}
            {isLoading ? (
              <div className="space-y-8" data-testid="jobs-loading">
                {[...Array(5)].map((_, i) => (
              ...
              <Card className="p-16 text-center shadow-2xl border-0 bg-white/80 backdrop-blur-sm animate-fade-in-up" data-testid="jobs-error">
                <div className="text-red-500 mb-6">
                  <Filter className="h-16 w-16 mx-auto mb-4" />
                  <h3 className="text-2xl font-bold">Error Loading Jobs</h3>
                </div>
              ...
              <Card className="p-16 text-center shadow-2xl border-0 bg-white/80 backdrop-blur-sm animate-fade-in-up" data-testid="no-jobs-found">
